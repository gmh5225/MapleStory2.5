...
public: /* 그려지는 순서에 따른 정의 */
	enum COLLSIONGROUP { COLLSION_PLAYER, COLLSION_MONSTER, COLLSION_NPC, COLLSION_PLAYER_SKILL, COLLSION_MONSTER_SKILL, COLLSION_BLOCK, COLLSION_PUSHBLOCK, COLLISION_ITEM, COLLSION_UI, COLLSION_POTAL, COLLSION_SECTION, COLLSION_END };
