...
class CGreenSlime final : public CCreature
{
	enum Direction {R,G,B,P};

private:
	CGreenSlime(LPDIRECT3DDEVICE9 pGraphic_Device);
	CGreenSlime(const CGreenSlime& rhs);
...
public:
	static CGreenSlime* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
