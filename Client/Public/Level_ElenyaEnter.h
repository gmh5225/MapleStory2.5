...
class CLevel_ElenyaEnter final : public CLevel
{
private:
	CLevel_ElenyaEnter(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CLevel_ElenyaEnter() = default;
...
public:
	static CLevel_ElenyaEnter* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
