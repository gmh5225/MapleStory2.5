...
class CChick final : public CCreature
{
private:
	CChick(LPDIRECT3DDEVICE9 pGraphic_Device);
	CChick(const CChick& rhs);
	virtual ~CChick() = default;
...
public:
	static CChick* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
