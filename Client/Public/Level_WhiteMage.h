...
class CLevel_WhiteMage final : public CLevel
{
private:
	CLevel_WhiteMage(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CLevel_WhiteMage() = default;
...
public:
	static CLevel_WhiteMage* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
