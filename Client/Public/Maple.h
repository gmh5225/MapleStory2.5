...
class CMaple final : public CCreature
{
private:
	CMaple(LPDIRECT3DDEVICE9 pGraphic_Device);
	CMaple(const CMaple& rhs);
	virtual ~CMaple() = default;
...
public:
	static CMaple* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
