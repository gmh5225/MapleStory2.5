...
class CLevel_Elenya final : public CLevel
{
private:
	CLevel_Elenya(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CLevel_Elenya() = default;
...
public:
	static CLevel_Elenya* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
