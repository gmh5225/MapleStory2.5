...
class CLevel_ElenyaGAS final : public CLevel
{
private:
	CLevel_ElenyaGAS(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CLevel_ElenyaGAS() = default;
...
public:
	static CLevel_ElenyaGAS* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
