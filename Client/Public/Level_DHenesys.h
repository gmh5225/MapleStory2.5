...
class CLevel_DHenesys final : public CLevel
{
private:
	CLevel_DHenesys(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CLevel_DHenesys() = default;
...
public:
	static CLevel_DHenesys* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
