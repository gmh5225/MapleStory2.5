...
class CLevel_BlackMageJump final : public CLevel
{
private:
	CLevel_BlackMageJump(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CLevel_BlackMageJump() = default;
...
public:
	static CLevel_BlackMageJump* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
