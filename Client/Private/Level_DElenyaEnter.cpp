#include "stdafx.h"
#include "..\Public\Level_DElenyaEnter.h"
...
CLevel_DElenyaEnter::CLevel_DElenyaEnter(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CLevel(pGraphic_Device)
{
}

HRESULT CLevel_DElenyaEnter::Initialize()
{
...
void CLevel_DElenyaEnter::Tick(_float fTimeDelta)
{
...
HRESULT CLevel_DElenyaEnter::Render()
{
...
HRESULT CLevel_DElenyaEnter::Ready_Layer_Camera(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_DElenyaEnter::Ready_Layer_Player(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_DElenyaEnter::Ready_Layer_BackGround(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_DElenyaEnter::Ready_Layer_Monster(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_DElenyaEnter::Ready_Layer_Npc(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_DElenyaEnter::Ready_Layer_Map(const _tchar * pLayerTag)
{
	...
	PotalDesc.Pos = _float3(-2.f, 1.f, -1.f);
	PotalDesc.DestPos = _float3(43.f, 3.f, -5.f);
	if (FAILED(pGameInstance->Add_GameObjectToLayer(TEXT("Prototype_GameObject_Potal"), LEVEL_DELENYAENTER, pLayerTag, &PotalDesc)))
		return E_FAIL;

	PotalDesc.eDestLevel = LEVEL_DELENYA;
	PotalDesc.Pos = _float3(35.f, 16.f, 6.f);
	...
	list<CMap_Manager::CUBEDATA>* pMapData = pGameInstance->ReadMap(L"Map_DElenyaEnter");
	for (auto& Data : *pMapData)
	{
		if (FAILED(pGameInstance->Add_GameObjectToLayer(TEXT("Prototype_GameObject_Cube"), LEVEL_DELENYAENTER, pLayerTag, &Data)))
			return E_FAIL;
	}


	list<CMap_Manager::MODELDESC>* pModelData = pGameInstance->ReadModel(L"Total_DElenyaEnter");
	if (nullptr != pModelData)
	{
		for (auto& Model : *pModelData)
		{
			...
			if (FAILED(pGameInstance->Add_GameObjectToLayer(TEXT("Prototype_GameObject_Wood"), LEVEL_DELENYAENTER, pLayerTag, &VoxDesc)))
				return E_FAIL;
		}
...
HRESULT CLevel_DElenyaEnter::Ready_Layer_Section(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
	...
	for (int j = -5; j < 15; j++)
	{
		for (int i = -5; i < 15; i++)
		{
			...
			if (FAILED(pGameInstance->Add_GameObjectToLayer(TEXT("Prototype_GameObject_Section"), LEVEL_DELENYAENTER, pLayerTag, &Data)))
				return E_FAIL;
		}
	}
...
HRESULT CLevel_DElenyaEnter::Ready_Layer_UI(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_DElenyaEnter::Ready_Layer_Spawner(const _tchar * pLayerTag)
{
...
HRESULT CLevel_DElenyaEnter::Ready_SkillFrameBtn(const _tchar * pLayerTag)
{
...
HRESULT CLevel_DElenyaEnter::Ready_SkillIcon(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_DElenyaEnter::Ready_SkillInfo()
{
...
HRESULT CLevel_DElenyaEnter::Ready_QuickSlot(const _tchar* pLayerTag)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_DElenyaEnter::Ready_QuickSlotSkill(const _tchar * pLayerTag)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
CLevel_DElenyaEnter * CLevel_DElenyaEnter::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CLevel_DElenyaEnter*		pInstance = new CLevel_DElenyaEnter(pGraphic_Device);
