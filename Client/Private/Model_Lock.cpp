#include "stdafx.h"
#include "..\Public\Model_Lock.h"

#include "GameInstance.h"
#include "ParticleManager.h"

CModel_Lock::CModel_Lock(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CModel_Lock::CModel_Lock(const CModel_Lock & rhs)
	: CGameObject(rhs)
{
}


HRESULT CModel_Lock::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CModel_Lock::Initialize(void * pArg)
{
...
void CModel_Lock::Tick(_float fTimeDelta)
{
...
void CModel_Lock::LateTick(_float fTimeDelta)
{
...
HRESULT CModel_Lock::Set_RenderState()
{
...
HRESULT CModel_Lock::Reset_RenderState()
{
...
HRESULT CModel_Lock::SetUp_Components()
{
...
void CModel_Lock::Collision(CGameObject * pOther)
{
...
CModel_Lock * CModel_Lock::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CModel_Lock*		pInstance = new CModel_Lock(pGraphic_Device);
...
CGameObject * CModel_Lock::Clone(void* pArg)
{
	CModel_Lock*		pInstance = new CModel_Lock(*this);
