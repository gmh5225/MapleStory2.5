#include "stdafx.h"
#include "..\Public\Level_WhiteMage.h"
...
HRESULT CLevel_WhiteMage::Initialize()
{
...
void CLevel_WhiteMage::Tick(_float fTimeDelta)
{
...
HRESULT CLevel_WhiteMage::Render()
{
...
HRESULT CLevel_WhiteMage::Ready_Layer_Camera(const _tchar * pLayerTag)
{
...
HRESULT CLevel_WhiteMage::Ready_Layer_Player(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_WhiteMage::Ready_Layer_BackGround(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_WhiteMage::Ready_Layer_Monster(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_WhiteMage::Ready_Layer_Npc(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_WhiteMage::Ready_Layer_Map(const _tchar * pLayerTag)
{
	...
	if (FAILED(pGameInstance->Add_GameObjectToLayer(TEXT("Prototype_GameObject_Potal"), LEVEL_WHITEMAGE, pLayerTag, &PotalDesc)))
		return E_FAIL;
	...
	//list<CMap_Manager::MODELDESC>* pModelData = pGameInstance->ReadModel(L"Model_WhiteMageds");
	...
	//		if (FAILED(pGameInstance->Add_GameObjectToLayer(TEXT("Prototype_GameObject_Wood"), LEVEL_WHITEMAGE, pLayerTag, &VoxDesc)))
	//			return E_FAIL;
	//	}
...
HRESULT CLevel_WhiteMage::Ready_Layer_Section(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
	...
	for (int j = -5; j < 15; j++)
	{
		for (int i = -5; i < 15; i++)
		{
			...
			if (FAILED(pGameInstance->Add_GameObjectToLayer(TEXT("Prototype_GameObject_Section"), LEVEL_WHITEMAGE, pLayerTag, &Data)))
				return E_FAIL;
		}
	}
...
HRESULT CLevel_WhiteMage::Ready_Layer_UI(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_WhiteMage::Ready_Layer_Spawner(const _tchar * pLayerTag)
{
...
HRESULT CLevel_WhiteMage::Ready_SkillFrameBtn(const _tchar * pLayerTag)
{
...
HRESULT CLevel_WhiteMage::Ready_SkillIcon(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_WhiteMage::Ready_SkillInfo()
{
...
HRESULT CLevel_WhiteMage::Ready_QuickSlot(const _tchar* pLayerTag)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_WhiteMage::Ready_QuickSlotSkill(const _tchar * pLayerTag)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
CLevel_WhiteMage * CLevel_WhiteMage::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CLevel_WhiteMage*		pInstance = new CLevel_WhiteMage(pGraphic_Device);
