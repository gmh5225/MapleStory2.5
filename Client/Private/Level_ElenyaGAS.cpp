#include "stdafx.h"
#include "..\Public\Level_ElenyaGAS.h"
...
HRESULT CLevel_ElenyaGAS::Initialize()
{
	...
	CGameInstance::Get_Instance()->PlayBGM(L"GASBattle.mp3", 1.f);
...
void CLevel_ElenyaGAS::Tick(_float fTimeDelta)
{
...
HRESULT CLevel_ElenyaGAS::Render()
{
...
HRESULT CLevel_ElenyaGAS::Ready_Layer_Camera(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_ElenyaGAS::Ready_Layer_Player(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_ElenyaGAS::Ready_Layer_BackGround(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_ElenyaGAS::Ready_Layer_Monster(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_ElenyaGAS::Ready_Layer_Npc(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_ElenyaGAS::Ready_Layer_Map(const _tchar * pLayerTag)
{
	...
	//list<CMap_Manager::MODELDESC>* pModelData = pGameInstance->ReadModel(L"Model_ElenyaGAS");
	...
	//		if (FAILED(pGameInstance->Add_GameObjectToLayer(TEXT("Prototype_GameObject_Wood"), LEVEL_GAS, pLayerTag, &VoxDesc)))
	//			return E_FAIL;
	//	}
...
HRESULT CLevel_ElenyaGAS::Ready_Layer_Section(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
	...
	for (int j = -5; j < 15; j++)
	{
		for (int i = -5; i < 15; i++)
		{
			...
			if (FAILED(pGameInstance->Add_GameObjectToLayer(TEXT("Prototype_GameObject_Section"), LEVEL_GAS, pLayerTag, &Data)))
				return E_FAIL;
		}
	}
...
HRESULT CLevel_ElenyaGAS::Ready_Layer_UI(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_ElenyaGAS::Ready_SkillFrameBtn(const _tchar * pLayerTag)
{
...
HRESULT CLevel_ElenyaGAS::Ready_SkillIcon(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_ElenyaGAS::Ready_SkillInfo()
{
...
HRESULT CLevel_ElenyaGAS::Ready_QuickSlot(const _tchar* pLayerTag)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_ElenyaGAS::Ready_QuickSlotSkill(const _tchar * pLayerTag)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
CLevel_ElenyaGAS * CLevel_ElenyaGAS::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CLevel_ElenyaGAS*		pInstance = new CLevel_ElenyaGAS(pGraphic_Device);
