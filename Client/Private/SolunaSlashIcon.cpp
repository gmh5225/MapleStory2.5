...
void CSolunaSlashIcon::Change_Texture()
{
	...
	if (m_eCollision == TYPE_DOWN && m_pSkillInfo->Get_SkillLevel() != 0)
		pMouseInstance->Set_SkillIconIndex(CMouseManager::TYPE_SKILL, L"SolunaSlashInfo", CSkillManager::GRADE_BEGENNER, m_pSkillInfo->Get_TextNum(), m_pSkillInfo->Get_SkillNotice());
