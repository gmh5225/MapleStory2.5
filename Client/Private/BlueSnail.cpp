...
HRESULT CBlueSnail::SetUp_Components()
{
...

	{
		...
		m_pAnimatorCom->Create_Texture(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Texture_BlueSnail_DieR"), nullptr);
		m_pAnimatorCom->Create_Texture(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Texture_BlueSnail_Die"), nullptr);
	}
