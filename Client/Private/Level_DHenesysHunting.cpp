#include "stdafx.h"
#include "..\Public\Level_DHenesysHunting.h"
...
HRESULT CLevel_DHenesysHunting::Initialize()
{
...
void CLevel_DHenesysHunting::Tick(_float fTimeDelta)
{
...
HRESULT CLevel_DHenesysHunting::Render()
{
...
HRESULT CLevel_DHenesysHunting::Ready_Layer_Camera(const _tchar * pLayerTag)
{
...
HRESULT CLevel_DHenesysHunting::Ready_Layer_Player(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_DHenesysHunting::Ready_Layer_BackGround(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_DHenesysHunting::Ready_Layer_Monster(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_DHenesysHunting::Ready_Layer_Npc(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_DHenesysHunting::Ready_Layer_Map(const _tchar * pLayerTag)
{
...
HRESULT CLevel_DHenesysHunting::Ready_Layer_Section(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
	...
	for (int j = -5; j < 15; j++)
	{
		for (int i = -5; i < 15; i++)
		{
			...
			if (FAILED(pGameInstance->Add_GameObjectToLayer(TEXT("Prototype_GameObject_Section"), LEVEL_DHENESYSHUNTING, pLayerTag, &Data)))
				return E_FAIL;
		}
	}
...
HRESULT CLevel_DHenesysHunting::Ready_Layer_UI(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_DHenesysHunting::Ready_SkillFrameBtn(const _tchar * pLayerTag)
{
...
HRESULT CLevel_DHenesysHunting::Ready_SkillIcon(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_DHenesysHunting::Ready_SkillInfo()
{
...
HRESULT CLevel_DHenesysHunting::Ready_QuickSlot(const _tchar* pLayerTag)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_DHenesysHunting::Ready_QuickSlotSkill(const _tchar * pLayerTag)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
CLevel_DHenesysHunting * CLevel_DHenesysHunting::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CLevel_DHenesysHunting*		pInstance = new CLevel_DHenesysHunting(pGraphic_Device);
...
void CLevel_DHenesysHunting::Free()
{
	__super::Free();
