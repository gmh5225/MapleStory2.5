...
HRESULT CBlackWizardAttack3::Initialize(void* pArg)
{
	...
	m_pAnimatorCom->Set_AniInfo(TEXT("Prototype_Component_Texture_BlackWizard_Attack3"), 0.07f, CAnimator::STATE_ONCE);
...
HRESULT CBlackWizardAttack3::SetUp_Components()
{
	...
	{
		m_pAnimatorCom->Create_Texture(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Texture_BlackWizard_Attack3"), nullptr);
	}
