#include "stdafx.h"
#include "..\Public\Level_BlackMageEnter.h"
...
CLevel_BlackMageEnter::CLevel_BlackMageEnter(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CLevel(pGraphic_Device)
{
}

HRESULT CLevel_BlackMageEnter::Initialize()
{
...
void CLevel_BlackMageEnter::Tick(_float fTimeDelta)
{
...
HRESULT CLevel_BlackMageEnter::Render()
{
...
HRESULT CLevel_BlackMageEnter::Ready_Layer_Camera(const _tchar * pLayerTag)
{
...
HRESULT CLevel_BlackMageEnter::Ready_Layer_Player(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_BlackMageEnter::Ready_Layer_BackGround(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_BlackMageEnter::Ready_Layer_Monster(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_BlackMageEnter::Ready_Layer_Npc(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_BlackMageEnter::Ready_Layer_Map(const _tchar * pLayerTag)
{
	...
	PotalDesc.DestPos = _float3(37.f, 23.f, 3.f);
	...
	list<CMap_Manager::CUBEDATA>* pMapData = pGameInstance->ReadMap(L"Map_DarkMageEnter");
	for (auto& Data : *pMapData)
	{
		if (FAILED(pGameInstance->Add_GameObjectToLayer(TEXT("Prototype_GameObject_Cube"), LEVEL_DARKMAGEENTER, pLayerTag, &Data)))
			return E_FAIL;
	}


	//list<CMap_Manager::MODELDESC>* pModelData = pGameInstance->ReadModel(L"Model_DarkMageEnter");
	...
	//		if (FAILED(pGameInstance->Add_GameObjectToLayer(TEXT("Prototype_GameObject_Wood"), LEVEL_DARKMAGEENTER, pLayerTag, &VoxDesc)))
	//			return E_FAIL;
	//	}
...
HRESULT CLevel_BlackMageEnter::Ready_Layer_Section(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
	...
	for (int j = -5; j < 15; j++)
	{
		for (int i = -5; i < 15; i++)
		{
			...
			if (FAILED(pGameInstance->Add_GameObjectToLayer(TEXT("Prototype_GameObject_Section"), LEVEL_DARKMAGEENTER, pLayerTag, &Data)))
				return E_FAIL;
		}
	}
...
HRESULT CLevel_BlackMageEnter::Ready_Layer_UI(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_BlackMageEnter::Ready_Layer_Spawner(const _tchar * pLayerTag)
{
...
HRESULT CLevel_BlackMageEnter::Ready_SkillFrameBtn(const _tchar * pLayerTag)
{
...
HRESULT CLevel_BlackMageEnter::Ready_SkillIcon(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_BlackMageEnter::Ready_SkillInfo()
{
...
HRESULT CLevel_BlackMageEnter::Ready_QuickSlot(const _tchar* pLayerTag)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_BlackMageEnter::Ready_QuickSlotSkill(const _tchar * pLayerTag)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
CLevel_BlackMageEnter * CLevel_BlackMageEnter::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CLevel_BlackMageEnter*		pInstance = new CLevel_BlackMageEnter(pGraphic_Device);
...
void CLevel_BlackMageEnter::Free()
{
	__super::Free();
