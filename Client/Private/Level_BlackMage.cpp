...
HRESULT CLevel_BlackMage::Ready_Layer_Camera(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_BlackMage::Ready_Layer_Player(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_BlackMage::Ready_Layer_BackGround(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_BlackMage::Ready_Layer_Map(const _tchar * pLayerTag)
{
	...
	//list<CMap_Manager::MODELDESC>* pModelData = pGameInstance->ReadModel(L"Model_DarkMage");
	...
	//		if (FAILED(pGameInstance->Add_GameObjectToLayer(TEXT("Prototype_GameObject_Wood"), LEVEL_DARKMAGE, pLayerTag, &VoxDesc)))
	//			return E_FAIL;
	//	}
...
HRESULT CLevel_BlackMage::Ready_Layer_Spawner(const _tchar * pLayerTag)
{
...
HRESULT CLevel_BlackMage::Ready_SkillFrameBtn(const _tchar * pLayerTag)
{
...
HRESULT CLevel_BlackMage::Ready_SkillIcon(const _tchar * pLayerTag)
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_BlackMage::Ready_SkillInfo()
{
...
HRESULT CLevel_BlackMage::Ready_QuickSlot(const _tchar* pLayerTag)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
HRESULT CLevel_BlackMage::Ready_QuickSlotSkill(const _tchar * pLayerTag)
{
	CGameInstance* pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
