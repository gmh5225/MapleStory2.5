...
HRESULT CSkillGradeBtn4::Initialize(void * pArg)
{
	...
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_SkillGradeBtn4"), TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
void CSkillGradeBtn4::Change_Texture()
{
	...
	if (pSkillInstance->Get_PlayerGrade() < 4)
	{
		m_iTexturenum = 0;
		return;
	}
