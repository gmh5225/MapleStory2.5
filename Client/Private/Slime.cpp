...
HRESULT CSlime::SetUp_Components()
{
...

	{
		...
		m_pAnimatorCom->Create_Texture(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Texture_Slime_DieR"), nullptr);
		m_pAnimatorCom->Create_Texture(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Texture_Slime_Die"), nullptr);
	}
